...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.isocity=");
    idx += (13 + "isocity".length);  // 
  }
  if (idx >= 0) {
